...
# new output projection0:
class OutputProj0(nn.Module):
    def __init__(self, input_resolution=None):
        super().__init__()
        self.input_resolution = input_resolution
...
# new output projection1:
class OutputProj1(nn.Module):
    def __init__(self, input_resolution=None):
        super().__init__()
        self.input_resolution = input_resolution
        self.dec_block = nn.Sequential(
...
# new output projection2:
class OutputProj2(nn.Module):
    def __init__(self, input_resolution=None):
        super().__init__()
        self.input_resolution = input_resolution
        self.dec_block = nn.Sequential(
...
# new output projection3:
class OutputProj3(nn.Module):
    def __init__(self, input_resolution=None):
        super().__init__()
        self.input_resolution = input_resolution
        self.dec_block = nn.Sequential(
...
class Panoformer(nn.Module):
    ...
    def forward(self, x):
        ...
        # outputs = {}
        # transferred_norm = self.depth2normal(y)
        # outputs["pred_depth"] = y
        # outputs["transferred_normal"] = transferred_norm
        output_features = [conv0] + [conv1] + [conv2] + [conv3] + [conv4]
